...
public class Constantes {
    public static String BIENVENIDA = "Bienvenidos a VoyEnBus";
    public static String INFO_VIAJES = "Los viajes encontrados para la ruta Mendoza - Buenos Aires son: ";
    public static String MEJOR_PRECIO = "VoyEnBus te recomienda el siguiente viaje con el mejor precio encontrado: ";
    public static String SEPARADOR = "---------------------------------";
    public static String EMPRESA = "Empresa: ";
    public static String DIA_SALIDA = "Dia salida: ";
    public static String HORA_SALIDA = "Hora salida: ";
    public static String DIA_LLEGADA = "Dia Llegada: ";
    public static String HORA_LLEGADA = "Hora Llegada: ";
    public static String DESDE = "Desde: ";
    public static String HACIA = "Hacia: ";
    public static String TIPO_ASIENTO = "Tipo asiento: ";
    public static String PRECIO = "Precio en $: ";
    
    public static String ERROR_JSON = "Se produjo un error al convertir el objeto json: ";
    public static String ERROR_API_CONEXION = "Se produjo un error al intentar conectarse con la API Voy en Bus";
